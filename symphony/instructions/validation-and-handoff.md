...
The demo-video command should generate a Playwright `.webm` artifact under `test-results/`. If the video cannot be generated, document the exact blocker and command failure.
...
- Whether the PR demo video was generated or why it could not be generated.
